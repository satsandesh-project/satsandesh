# Content Stewardship — Policy Taxonomy

_Status: draft — co-designed with the organization in Month 1, versioned
here like code. Policy changes are pull requests, not verbal agreements._
